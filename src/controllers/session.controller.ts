...
export const createSession = async (
  ...
  try {
    ...
    if (!req.user?.role_names?.includes("Admin")) {
...
export const editSession = async (
  ...
  try {
    ...
    const session = await sessionService.editSession(school_id, session_id, {
      name: value.name,
...
export const getSessions = async (
  ...
  try {
    ...
    if (
      !req.user?.role_names?.includes("Admin") &&
...
export const getUserSessionsTerms = async (
  ...
  try {
    ...
    const role_names = req.user?.role_names;
